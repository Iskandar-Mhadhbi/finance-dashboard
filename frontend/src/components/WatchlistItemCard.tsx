    ...
    <li className="bg-white p-4 rounded-lg shadow-sm flex justify-between items-center">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-blue-50 border border-blue-200 text-blue-600 rounded-lg text-sm hover:bg-blue-100 transition-colors"
        >
          Details
        </button>
        ...
        <button
          ...
          className="px-3 py-1.5 bg-red-50 border border-red-200 text-red-500 rounded-lg text-sm hover:bg-red-100 transition-colors"
        >
          Remove
        </button>
      </div>
